...
Идею подхватывает цикл, отмеряющий системе строгий лимит попыток. Прогонов по умолчанию не больше пяти, неудачных заходов подряд не больше четырёх, и работа, не законченная в отведённых рамках, обрывается.

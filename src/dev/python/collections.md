...
**Совет:** При необходимости частых операций с обоих концов целесообразно использовать `collections.deque` (устройство дека и сравнительные измерения со списком приведены в главе [«Основные структуры данных»](../../cs/basic-structures.md)).

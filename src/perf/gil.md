...
С числами из разделов выше эту пару сопоставлять не следует: она снята отдельно.
...
Если программа ожидает сети, диска, прибора, ответа пользователя, следует использовать потоки. GIL на время ожидания освобождается, потоки дёшевы, и десятки одновременно висящих ожиданий обходятся почти бесплатно. Если ожиданий предстоят тысячи, следует перейти к асинхронности, рассматриваемой в следующей главе.

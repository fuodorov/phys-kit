...
Реализация работает корректно; её скорость измеряется магической командой `%%timeit`, описанной в главе [«Причины низкой скорости Python»](../dev/python/optimization.md).

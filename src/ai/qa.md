...
Следует посмотреть свежее сравнение на независимой площадке наподобие [Artificial Analysis](https://artificialanalysis.ai), отобрать две-три модели и прогнать на них **собственные** типичные задачи. Разница между лидерами рейтинга обычно меньше, чем разница между задачами пользователя и теми, на которых рейтинг составлялся.

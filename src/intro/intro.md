...
Читать пособие рекомендуется последовательно, поскольку главы опираются друг на друга. Если какая-либо тема требуется немедленно, следует воспользоваться оглавлением и перекрёстными ссылками.

**Читать пособие без клавиатуры не рекомендуется.** Каждый пример следует набрать самостоятельно, изменить и проанализировать результат. Задания в конце пособия предназначены именно для этого.
...
Замеченные ошибки и предложения следует направлять в issues репозитория; они будут учтены в следующем издании.

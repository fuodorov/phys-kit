...
### Основная часть
1. Тестовая программа — скрипт с шебангом `#!/usr/bin/bash` и бесконечным циклом `while true; do echo "I am still alive"; sleep 1; done`; развёрнутый листинг лежит в репозитории задания.

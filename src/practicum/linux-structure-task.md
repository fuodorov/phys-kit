...
> Опирается на главы [«Внутреннее устройство Linux»](../linux/structure.md) и [«Инструменты Linux»](../linux/tools.md), в которых разобраны процессы, состояния, сигналы и планировщик.

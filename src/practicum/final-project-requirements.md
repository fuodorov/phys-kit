...
> Опирается на всю книгу, прежде всего на главы [«Требования к коду»](../dev/python/requirements.md), [«Жизненный цикл ПО»](../dev/life.md) и [«От скрипта к приложению»](../dev/app.md), откуда следуют требования к сборке, тестам и документации. Примеры доведённой до конца работы приведены в части [«Учимся у других»](../examples/intro.md).

...
Репозитория-заготовки у этого задания нет: он создаётся участниками самостоятельно, и его устройство входит в состав работы. Устройство репозитория разобрано в главе [«Git»](../dev/git.md), конвейер сборки — в главе [«Жизненный цикл ПО»](../dev/life.md).

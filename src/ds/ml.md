...
На плоскости точки одного класса группируются каждая в своей области пространства признаков.
...
и метрики качества классификатора. Доля правильных ответов (accuracy) вводит в заблуждение, и полагаться на неё в одиночку нельзя.
